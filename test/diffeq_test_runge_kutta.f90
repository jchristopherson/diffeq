...
! ------------------------------------------------------------------------------
function test_implicit_runge_kutta_4_1() result(rst)
    ! Arguments
    logical :: rst
    ...
    if (.not.assert(ans, sol(:,2), tol)) then
        rst = .false.
        print "(A)", "TEST FAILED: test_implicit_runge_kutta_4_1 -1"
    end if
end function

! ------------------------------------------------------------------------------
function test_implicit_runge_kutta_4_2() result(rst)
    ! Arguments
    logical :: rst
    ...
    if (.not.assert(ans, sol(:,2), tol)) then
        rst = .false.
        print "(A)", "TEST FAILED: test_implicit_runge_kutta_4_2 -1"
    end if
end function

! ------------------------------------------------------------------------------
function test_implicit_runge_kutta_4_3() result(rst)
    ! Arguments
    logical :: rst
    ...
    if (.not.assert(ans, sol(:,2), tol)) then
        rst = .false.
        print "(A)", "TEST FAILED: test_implicit_runge_kutta_4_3 -1"
    end if
end function
